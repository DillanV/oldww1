...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1910.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	BASE_CONDITIONAL_PEACE_WARESCORE_RATIO = 0.4, 	-- Warscore ratio needed for the losing side to able to surrender.
